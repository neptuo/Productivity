...
{
    internal class FormStringCompletionProvider : ICSharpStringCompletionProvider
    {
        private readonly IGlyphService glyphService;
        private readonly List<string> completionItems = new List<string>() { "Person.List", "Person.Edit", "BusinessCase.List", "BusinessCase.Edit" };

        public FormStringCompletionProvider(IGlyphService glyphService)
        {
